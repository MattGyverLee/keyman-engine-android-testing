...
public class SystemKeyboard extends InputMethodService implements OnKeyboardEventListener {
  ...
  public void onCreate() {
    ...
    kbInfoQ.put(KMManager.KMKey_KeyboardID, "sil_cameroon_qwerty");
    kbInfoQ.put(KMManager.KMKey_LanguageID, "ewo");
    kbInfoQ.put(KMManager.KMKey_KeyboardName, "Cameroon Qwerty");
    kbInfoQ.put(KMManager.KMKey_LanguageName, "Ewondo");
    kbInfoQ.put(KMManager.KMKey_KeyboardVersion, "6.0.4");
    kbInfoQ.put(KMManager.KMKey_Font, "andikaa.ttf");
    //kbInfoQ.put(KMManager.KMKey_Font, KMManager.KMDefault_KeyboardFont); // Use the default font
    ...
    kbInfoA.put(KMManager.KMKey_KeyboardID, "sil_cameroon_azerty");
    kbInfoA.put(KMManager.KMKey_LanguageID, "ewo");
    kbInfoA.put(KMManager.KMKey_KeyboardName, "Cameroon Azerty");
    kbInfoA.put(KMManager.KMKey_LanguageName, "Ewondo");
    kbInfoA.put(KMManager.KMKey_KeyboardVersion, "6.0.2");
