...
public class SystemKeyboard extends InputMethodService implements OnKeyboardEventListener {
  ...
  public void onCreate() {
    ...
    Keyboard kbInfoQ = new Keyboard(
      "sil_cameroon_qwerty", // Package ID - filename of the .kmp file
      "sil_cameroon_qwerty", // Keyboard ID
    ...
    Keyboard kbInfoA = new Keyboard(
            "sil_cameroon_azerty", // Package ID - filename of the .kmp file
            "sil_cameroon_azerty", // Keyboard ID
